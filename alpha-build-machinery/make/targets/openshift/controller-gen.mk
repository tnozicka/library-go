...
ifeq "" "$(wildcard $(CONTROLLER_GEN))"
	$(info Installing ensure-controller-gen into "$(CONTROLLER_GEN)")
	...
	cd '$(CONTROLLER_GEN_TEMP)' && export GO111MODULE=on GOPATH='$(shell pwd)/$(CONTROLLER_GEN_TEMP)/../..' && $(GO) mod vendor && $(GO) build -mod=vendor ./cmd/controller-gen
else
	$(info Using existing ensure-controller-gen from "$(CONTROLLER_GEN)")
endif
.PHONY: ensure-controller-gen

clean-controller-gen:
	$(RM) -r '$(CONTROLLER_GEN_TEMP)'
